...
const TutorsType = () => {
  ...
  return (
    <div className="hidden sm:flex sm:flex-col justify-between h-[282px] bg-[#F6F7FB] rounded-4xl sm:w-1/2 px-4 pt-4">
      ...
      <div className="w-full text-center text-xs leading-4 font-helveticaneue-regular text-[#737373] pb-[26px] pt-[18px]">
