...
//       <div className="w-full max-w-[1920px] 3xl:mx-auto 3xl:px-10 overflow-hidden">
//         <Swiper
//           modules={[Navigation]}
//           spaceBetween={16}
//           slidesPerView={1.2}
...
//       <div
//         className="w-full flex items-center justify-center pt-6 lg:pt-8 sm:justify-between
//       px-4 sm:px-6 lg:px-11 3xl:px-[160px] max-w-[1920px] 3xl:mx-auto"
//       >
