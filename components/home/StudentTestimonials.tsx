  ...
  return (
    <div className="pt-8 sm:pt-[44px] lg:pt-[64px] 3xl:pt-[84px]">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-4">
          <div className="inline-flex flex-col bg-[#52CE91] text-center px-[26px] py-[20px] rounded-3xl gap-4 sm:items-center sm:gap-6 sm:p-[32px]">
            <span className="font-lgvanastasia-regular text-[32px] leading-9 text-[#0C0F21] sm:w-[383px] sm:text-[52px] sm:leading-[52px]">
          ...
          >
            ...
            />
            <div className="flex flex-col gap-4 sm:justify-between sm:h-[252px]">
              <span className="text-sm leading-5 text-[#0C0F21] text-start font-helveticaneue-regular">
        ...
        <div className="flex flex-col gap-4">
          <div className="relative w-full h-[200px] sm:h-[296px] rounded-3xl overflow-hidden">
            <Image
            ...
            <div className="absolute inset-0 flex flex-col items-end justify-end text-right text-white p-4 sm:p-8">
          ...
          <div className="flex flex-col gap-4 sm:flex-row ">
            ...
            <div className="bg-[#ECE3FF] rounded-3xl p-6 flex flex-col gap-[74px] sm:w-1/2 sm:h-[296px] sm:justify-between">
